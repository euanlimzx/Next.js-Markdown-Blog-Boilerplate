...
tldr; built my own distributed query engine. If you’re purely interested in the technical aspects of this project, you can skip [here](##technical-architecture) or view its full set of features in the [Github repository](https://github.com/euanlimzx/distributed-query-engine).
